    ...
    <div>
      ...
      <!-- <img src="../assets/timg.jpg" alt=""> -->
            <div id="d1">
                ...
                <div>
                    <p><span style="width:100px; display: inline-block; text-align:right;">确认密码：</span><input type="password" v-model="conpassword"  placeholder="请再次输入密码" @blur.capture="checkConpassword" state="conpasswordState"></p>
                </div>
                <h-button class="h-btn h-btn-primary h-btn-l" @click="handle">注册</h-button>
